  ...
  <TBODY>
    ...
    <TR> 
      <TD height="61" colspan="2"><table width="926" height="120" border="0" cellpadding="5" cellspacing="4">
          <tr> 
            <td height="31" colspan="8" bgcolor="#CCCCCC"><div align="center"><em><strong><font color="#990000" size="4">Geneology 
			...
			function display_downlines($root_id)
				  {
					if($root_id!=NULL)
					  {
								//$customerid=customerid_numonly($root_id);
								$q="SELECT * FROM customer WHERE customer_id=$root_id";
