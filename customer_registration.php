				  ...
				  <TD align=left> <TABLE height=500 width=615 border=0>
					  <TBODY>
                        ...
                        <table width="98%" border="0" cellpadding="6" cellspacing="8">
						  ...
						  <?php
						 	...
						 	if(in_array('salutation',$field_name))
							    show_salutation();
						 ...
						 ?>
                          <tr id="birthdate"> 
                            ...
                            <td height="32" colspan="2" valign="top" class="vertical" ><select name="birth_date" id="Birth date" style="width:42px;">
                              ...
                              </select> <select name="birth_year" id="Birth year" style="width:60px;">
					...
					function  show_nationality()
						...
						function  show_occupation()
						{
						 ?>
                          <tr id="occupation"> 
                            <td height="32" valign="top" class="vertical" id=main_content ><div align="left">Occupation 
                                :<font color="#990000">*</font></div></td>
                            <td height="32" colspan="2" valign="top" class="vertical" ><select name="occupation" id="occupation" style="width:200px;">
                                <option value="Engineer" >Engineer</option>
                                <option value="Doctor" selected style="BACKGROUND-COLOR: #f0f5f7;" >Doctor</option>
						...
						function  show_beneficiary()
						{
						 ?>
						  ...
						  <?php
						 	...
						 	if(in_array('middle_name',$field_name))
							    show_middlename();
								
						    if(in_array('last_name',$field_name))
							    show_lastname();
								
							 if(in_array('birth_date',$field_name))
							    show_birthdate();
								
							if(in_array('gender',$field_name))
							    show_gender();
								
							if(in_array('nationality',$field_name))
							    show_nationality();
						   if(in_array('occupation',$field_name))
							    show_occupation();
							
						    if(in_array('benificiary_name',$field_name))
							    show_beneficiary();
