...
<table width="40%" height="262" border="0" align="center" cellpadding="6" cellspacing="8"  >
  <!--DWLayoutTable-->
  <tr> 
    <td valign="top" class="vertical"> <form action="adminchecker.php" method="post" name="adminlogin" id="adminchecker.php">
        <table width="89%" height="172" border="0" cellpadding="4" cellspacing="4" bordercolor="#CCCCCC" bgcolor="#CCCCCC">
          <tr bgcolor="#495e83"> 
            <td height="26" colspan="4"><font color="#FFFFFF">Admin Login</font></td>
          </tr>
          <tr bgcolor="#CCCCCC"> 
