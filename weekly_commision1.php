...
//include_once("admin/common_functions.inc");
  ...
  //$allleft_qualified=qualified_allleftdownlines($customer['left_descendant_id']);
  //$allright_qualified=qualified_allrightdownlines($customer['right_descendant_id']);
  ...
  //$thisweek_left=newleft_qualified($customer['left_descendant_id'],$thismonday);//those who are qualified this week among the registered ones
  //$thisweek_right=newright_qualified($customer['right_descendant_id'],$thismonday);

 		$left_total=$thisweekregistered_left;
	 $right_total=$thisweekregistered_right;
            ...
            <td width="640" rowspan="2"><table width="103%" border="0" align="left" cellpadding="2" cellspacing="0" style="border:3 dotted red">
                ...
                <tr> 
                  ...
                  <td style="border-bottom:3 dashed cccccc"><font size="+1" color="#990000"> 
                    <?php  if($totalflushoff==0) echo "-"; else echo $totalflushoff; ?></font>
                  </td>
                </tr>
                <tr> 
                  <td rowspan="2" style="border-bottom:3 dashed cccccc">Deposit(evoucher):</td>
                  <td>Evoucher:</td>
                  <td><font size="+1" color="#990000"> 
